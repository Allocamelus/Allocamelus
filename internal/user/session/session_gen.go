...
func (z *Session) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 4
	// write "loggedIn"
	err = en.Append(0x84, 0xa8, 0x6c, 0x6f, 0x67, 0x67, 0x65, 0x64, 0x49, 0x6e)
	if err != nil {
		return
	}
...
func (z *Session) MarshalMsg(b []byte) (o []byte, err error) {
	...
	// map header, size 4
	// string "loggedIn"
	o = append(o, 0x84, 0xa8, 0x6c, 0x6f, 0x67, 0x67, 0x65, 0x64, 0x49, 0x6e)
...
func (z *Session) Msgsize() (s int) {
	s = 1 + 9 + msgp.BoolSize + 7 + msgp.Int64Size + 6 + z.Perms.Msgsize() + 11 + msgp.BytesPrefixSize + len(z.LoginToken)
	return
}
