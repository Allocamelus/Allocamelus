<template>
  <div class="hidden ml-6 w-64 items-stretch md:flex flex-col">
    <box v-if="loggedIn" class="py-3 px-4">
      <div class="w-max mx-auto">
        <basic-btn to="/post/new" class="text-white bg-secondary-700 hover:bg-secondary-800 py-2 px-3.5">
          New Post
        </basic-btn>
      </div>
    </box>
    <box v-else class="py-2 px-3">
      <div class="flex w-max mx-auto">
        <basic-btn to="/signup" class="text-white bg-secondary-700 hover:bg-secondary-800 py-2 px-3.5">
          Sign Up
        </basic-btn>
